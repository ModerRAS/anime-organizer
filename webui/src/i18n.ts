...
const zh: Record<string, string> = {
  ...
  'idle': '空闲', 'validating': '校验中', 'running': '运行中', 'canceling': '正在取消', 'stopping': '停止中', 'error': '错误', 'queued': '排队中', 'succeeded': '成功', 'failed': '失败', 'canceled': '已取消',
  'manual': '手动', 'scheduled': '计划任务', 'qbittorrent': 'qBittorrent',
  'organize': '整理', 'normalize_layout': '布局统一', 'compact_artwork_packs': '图片包压实', 'scrape': '刮削', 'match_aliases': '匹配别名', 'build_bangumi_db': '构建 Bangumi 数据库', 'extract_aliases': '提取别名', 'merge_aliases': '合并别名', 'apply_matches': '应用匹配', 'create_alias_issues': '创建别名 Issues', 'torrent_scrape': '种子刮削', 'rss_poll': 'RSS 轮询', 'rss_poll_all': '全部 RSS 轮询', 'cloud_add_offline': 'CloudDrive 离线下载',
}
