...
const zh: Record<string, string> = {
  ...
  'Subscription saved.': '订阅已保存。', 'Subscription updated.': '订阅已更新。', 'Subscription deleted.': '订阅已删除。', 'Connection required': '需要连接', '{seconds}s': '{seconds} 秒', '{minutes}m': '{minutes} 分钟', 'Organization': '整理', 'Automatic': '自动', 'Off': '关闭', 'Auto organize': '自动整理', 'Automatically organize completed downloads': '自动整理已完成的下载', 'Remote organize target folder': '远程整理目标目录', 'Remove empty source folders': '删除空的源目录', 'Last organization check': '上次整理检查', 'Run remote organization': '立即远程整理', 'Run remote organization now?': '确认立即执行远程整理？', 'Remote organization queued as job #{id}': '远程整理已加入任务队列 #{id}',
