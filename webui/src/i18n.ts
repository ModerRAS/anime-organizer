...
export function formatDateTime(value: string | null | undefined): string {
  ...
  return Number.isNaN(date.getTime()) ? '-' : date.toLocaleString(locale.value === 'zh-CN' ? 'zh-CN' : 'en-US')
}
